  ...
  <SRContents>
    ...
    <template #Content-Body>
      <div class="flex 2xl:block 2xl:space-y-2">
        ...
        <!-- column 2 -->
        <div id="right" class="flex flex-wrap w-[555px] gap-[20px] 2xl:w-full lg:flex-none lg:gap-2">
          <div
            class="flex flex-wrap w-full [&>div]:border-3 [&>div]:rounded-lg lg:[&>div]:w-full [&>div]:border-solid [&>div]:border-gray-300 gap-[20px] lg:flex lg:flex-none lg:gap-2">
...
import { customerRetrieveData } from "@/services/ApiServices.js";
